...
const WORKOUTS: Workout[] = [
  ...
  },
  {
    ...
    exercises: [
      { name: 'Shoulder Rolls & Wrist Circles', duration: 60, restDuration: 0, image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Hip Rotations & Leg Swings', duration: 60, restDuration: 0, image: 'https://images.unsplash.com/photo-1597452485669-2c7bb5fef90d?q=80&w=400&auto=format&fit=crop' },
      { name: 'Jump Rope (or simulate)', duration: 60, restDuration: 0, image: 'https://images.unsplash.com/photo-1434608519344-49d77a699e1d?q=80&w=400&auto=format&fit=crop' },
      { name: 'Push-Ups', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Inverted Rows (Table/Bar)', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1598575419181-98bb2955ec89?q=80&w=400&auto=format&fit=crop' },
      { name: 'Deep Squat Hold', duration: 45, restDuration: 15, image: 'https://images.unsplash.com/photo-1574680096145-d05b474e2158?q=80&w=400&auto=format&fit=crop' },
      { name: 'Dips (Chair / Parallettes)', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1591948970421-14b98694671c?q=80&w=400&auto=format&fit=crop' },
      { name: 'Pike Push-Ups', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1599058917233-358368395ff6?q=80&w=400&auto=format&fit=crop' },
      { name: 'Archer Push-Ups', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Jump Squats', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1574680096145-d05b474e2158?q=80&w=400&auto=format&fit=crop' },
      { name: 'Hollow Body Hold', duration: 30, restDuration: 15, image: 'https://images.unsplash.com/photo-1566241134883-13eb2393a3cc?q=80&w=400&auto=format&fit=crop' },
      { name: 'Tuck Compression Hold', duration: 30, restDuration: 15, image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Negative Push-Ups (Slow)', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Broad Jump + Walk Back', duration: 40, restDuration: 110, image: 'https://images.unsplash.com/photo-1434608519344-49d77a699e1d?q=80&w=400&auto=format&fit=crop' },
      { name: 'Push-Ups', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Inverted Rows (Table/Bar)', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1598575419181-98bb2955ec89?q=80&w=400&auto=format&fit=crop' },
      { name: 'Deep Squat Hold', duration: 45, restDuration: 15, image: 'https://images.unsplash.com/photo-1574680096145-d05b474e2158?q=80&w=400&auto=format&fit=crop' },
      { name: 'Dips (Chair / Parallettes)', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1591948970421-14b98694671c?q=80&w=400&auto=format&fit=crop' },
      ...
      { name: 'Tuck Compression Hold', duration: 30, restDuration: 15, image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Negative Push-Ups (Slow)', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Broad Jump + Walk Back', duration: 40, restDuration: 20, image: 'https://images.unsplash.com/photo-1434608519344-49d77a699e1d?q=80&w=400&auto=format&fit=crop' },
      { name: 'Wrist & Forearm Stretch', duration: 60, restDuration: 0, image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Cross-Body Shoulder Stretch', duration: 60, restDuration: 0, image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&auto=format&fit=crop' },
      { name: 'Pigeon Pose', duration: 60, restDuration: 0, image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&auto=format&fit=crop' },
    ]
  }
];
